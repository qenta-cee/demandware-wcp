...
function requireLogin(params) {
    ...
    redirectUrl = dw.web.URLUtils.https('Login-Show', 'original', browsing.lastUrl());
...
function switchToHttps() {
    ...
    url = 'https://' + request.httpHost + request.httpPath;
...
function ensure(filters, action, params) {
    return expose(function (args) {
        ...
        var errors = [];
        var i;
        params = require('~/cartridge/scripts/object').extend(params, args); // eslint-disable-line no-param-reassign
